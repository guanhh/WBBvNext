...
namespace WalkingTec.Mvvm.Admin.Api
{
    ...
    public class FileApiController : BaseApiController
    {
        ...
        public IActionResult Upload([FromServices] WtmFileProvider fp, [FromForm] string csName, string sm = null, string groupName = null, string subdir = null, string extra = null)
        {
        ...
        public IActionResult UploadImage([FromServices] WtmFileProvider fp, [FromForm] string csName, int? width = null, int? height = null, string sm = null, string groupName = null, string subdir = null, string extra = null)
        {
            if (width == null && height == null)
            {
                return Upload(fp, csName, sm, groupName);
            }
            var FileData = Request.Form.Files[0];
        ...
        public async Task<IActionResult> GetFile([FromServices] WtmFileProvider fp, string id, string csName, int? width = null, int? height = null)
        {
